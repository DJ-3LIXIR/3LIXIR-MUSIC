...
const TOOLS = [
  {
    ...
    description: "Search the knowledge base for solutions to customer questions.",
    input_schema: {
      type: "object",
      properties: {
        query: {
  ...
  {
    name: "create_ticket",
    description: "Create a support ticket for issues that require human intervention, custom quotes, or escalation.",
    input_schema: {
      type: "object",
      properties: {
        title: {
